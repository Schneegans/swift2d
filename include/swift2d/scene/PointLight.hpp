...
#ifndef SWIFT2D_POINT_LIGHT_CORE_HPP
#define SWIFT2D_POINT_LIGHT_CORE_HPP
...
typedef std::shared_ptr<const PointLight> ConstPointLightPtr;

// -----------------------------------------------------------------------------
class PointLight : public Core {
 ...
 public:
  ...
  static PointLightPtr create(Config const& config = Config()) {
    return std::make_shared<PointLight>(config);
  }

  PointLight(Config const& config = Config()) : config_(config) {}
...
#endif  // SWIFT2D_POINT_LIGHT_CORE_HPP
