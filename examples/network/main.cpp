...
#include <stdio.h>
#include <stdlib.h>
#include <raknet/src/Lobby2Client_Steam.h> // If Lobby2Client_Steam.h is included before SocketLayer.h, then it will use the steam send functions
#include <raknet/src/Lobby2Message_Steam.h>
#include <raknet/src/RakNetTime.h>
#include <raknet/src/RakSleep.h>
...
#include <raknet/src/Kbhit.h>
#include <raknet/src/Gets.h>
      ...
      case 'd':
        {
          ...
          printf("Enter room id, or enter for %lu: ", lastRoom);
          char str[256];
          Gets(str, sizeof(str));
          if (str[0]==0)
          {
